  ...
  static showWalkthroughOverlay(goalTitle) {
    ...
    overlay.innerHTML = `
      ...
      <div style="font-size:0.75rem; color:#8b949e; line-height:1.4;">
        <strong>Step 1:</strong> Tap <strong>"📋 Copy Outbox Package"</strong> in the Outbox card, then paste it into ChatGPT, Claude, or Gemini!
      </div>
      <div style="display:flex; gap:0.4rem; margin-top:0.3rem;">
        <button id="btn-walk-highlight-outbox" style="flex:1; padding:0.45rem; background:#8257e5; color:#fff; border:none; border-radius:6px; font-size:0.72rem; font-weight:bold; cursor:pointer; font-family:monospace;">📤 Focus Outbox</button>
        <button id="btn-walk-highlight-inbox" style="flex:1; padding:0.45rem; background:#238636; color:#fff; border:none; border-radius:6px; font-size:0.72rem; font-weight:bold; cursor:pointer; font-family:monospace;">📥 Focus Inbox</button>
      </div>
    `;
