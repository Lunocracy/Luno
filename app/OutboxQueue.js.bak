class OutboxQueue {
  ...
  static async executeSmartBundle(bundleOptions) {
    try {
      var opts = (typeof bundleOptions === 'object' && bundleOptions !== null) ? bundleOptions : { includeInstructions: true };
