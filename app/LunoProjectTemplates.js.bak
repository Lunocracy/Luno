class LunoProjectTemplates {
  ...
  static TEMPLATES = [
    {
      ...
      desc: 'Single-page web application template with Luno protocol & files.json support.',
      files: {
        ...
        'src/App.js': 'class App {\n  async run(env) {\n    const target = env.container || document.body;\n    target.innerHTML = "";\n    const card = makeElement("div", { style: { padding: "2rem", color: "#00f2fe", textAlign: "center" } },\n      makeElement("h1", "🚀 Welcome to Starter App"),\n      makeElement("p", { style: { color: "#8b949e", marginTop: "0.5rem" } }, "Interactive Luno app initialized successfully!")\n    );\n    target.appendChild(card);\n  }\n}'
      }
    },
    {
      id: '3d_app',
      name: '🎲 Three.js 3D Viewport App',
      desc: 'Interactive 3D Three.js viewport template using ThreeJSLoader & OrbitControls.',
      files: {
        'luno.json': '{\n  "name": "3D Viewport App",\n  "version": "1.0.0",\n  "description": "Three.js 3D viewport application",\n  "type": "luno-web-app",\n  "mainClass": "App3D",\n  "main": ["src/App3D.js"],\n  "library": ["DomBasics.js", "UITools.js", "ThreeJSLoader.js"],\n  "styles": ["css/app3d.css"]\n}',
        'files.json': '{\n  "main": ["src/App3D.js"],\n  "local": [],\n  "library": ["DomBasics.js", "UITools.js", "ThreeJSLoader.js"],\n  "thirdParty": []\n}',
        'index.html': '<!DOCTYPE html>\n<html>\n<head>\n  <meta charset="UTF-8">\n  <title>3D Viewport App</title>\n  <style>\n    * { box-sizing: border-box; margin: 0; padding: 0; }\n    body { background: #0d1117; color: #c9d1d9; font-family: system-ui, sans-serif; min-height: 100vh; overflow: hidden; }\n    #app-container { width: 100vw; height: 100vh; }\n  </style>\n</head>\n<body>\n  <div id="app-container"></div>\n  <script src="/app/acorn.js"><\/script>\n  <script src="/app/LunoLoader.js"><\/script>\n  <script>\n    document.addEventListener("DOMContentLoaded", function() {\n      if (typeof LunoLoader !== "undefined") {\n        LunoLoader.loadApp("app-container");\n      }\n    });\n  <\/script>\n</body>\n</html>',
        'css/app3d.css': 'body { margin: 0; overflow: hidden; background: #000; }',
        'src/App3D.js': 'class App3D {\n  async run(env) {\n    const target = env.container || document.body;\n    target.innerHTML = "<div style=\'padding:2rem; color:#00f2fe; text-align:center;\'><h2>🎲 3D Viewport App Initialized</h2><p style=\'color:#8b949e; margin-top:0.5rem;\'>ThreeJSLoader & OrbitControls active.</p></div>";\n  }\n}'
      }
    }
  ];
  ...
  static buildProjectCard(p, container) {
    ...
    const card = el('div', {
      ...
      el('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } },
        ...
        }, isActive ? '✓ Active Target' : (isLib ? 'Shared Library' : 'Project'))
      ),
  ...
  static async createFromTemplate(templateId, parentDir) {
    ...
    const projName = prompt('Enter new project directory name:', 'my_new_project');
    ...
    try {
      if (typeof ClientApp !== 'undefined' && ClientApp.setTargetProject) {
        ClientApp.setTargetProject(projName.trim(), { openTab: true });
      }
      await fetch('/api/save?project=' + encodeURIComponent(projName.trim()), {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ files: filesList, serverScript: '', project: projName.trim() })
      });
      if (typeof LunoSpaDock !== 'undefined') {
        LunoSpaDock.mountView('projects');
      }
